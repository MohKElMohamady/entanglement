...
func (c *solvayServiceClient) GetConferencesForPhysicists(ctx context.Context, opts ...grpc.CallOption) (SolvayService_GetConferencesForPhysicistsClient, error) {
	stream, err := c.cc.NewStream(ctx, &SolvayService_ServiceDesc.Streams[0], "/cosmological_constant.SolvayService/GetConferencesForPhysicists", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *solvayServiceGetConferencesForPhysicistsClient) Send(m *Physicist) error {
...
func (x *solvayServiceGetConferencesForPhysicistsServer) Recv() (*Physicist, error) {
	m := new(Physicist)
...
var SolvayService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cosmological_constant.SolvayService",
